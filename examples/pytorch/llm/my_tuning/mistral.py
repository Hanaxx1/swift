...
# count = 0
# 打开JSON文件
with open('/home/qiuyang/workplace/swift/examples/pytorch/llm/my_tuning/data/c4_data6.json', 'r') as file:
    # 逐行读取文件内容
    for line in file:
        # 解析JSON数据
...
for i in range(0,len(content_list)):
    ...
    result_mistral.append(response_llama)
        ...
        # 指定本地文件路径
file_path = '/home/qiuyang/workplace/swift/examples/pytorch/llm/my_tuning/data_siyuanzu/mistral_list6_base_xianyan.json'
