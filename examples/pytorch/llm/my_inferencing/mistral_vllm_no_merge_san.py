...
# #mistral
# mistral_checkpoint = '/home/qiuyang/workplace/swift/examples/pytorch/llm/output/mistral-7b-instruct-v2/v4-20240419-141730/checkpoint-1114'
...
# #openchat
openchat_checkpoint = '/home/qiuyang/workplace/swift/examples/pytorch/llm/output/openchat_3.5/v1-20240420-011323/checkpoint-1122'
...
#solar
# solar_checkpoint = '/home/qiuyang/workplace/swift/examples/pytorch/llm/output/solar-10.7b-instruct/v5-20240420-122343/checkpoint-1126'
...
# count = 0
# 打开JSON文件
with open('/home/qiuyang/workplace/swift/examples/pytorch/llm/my_data/data/c4_data_jingtai/c4_data11_3500_jingtai.json', 'r') as file:
    # 逐行读取文件内容
    for line in file:
        # 解析JSON数据
...
resp_list = inference_vllm(openchat_engine, template, request_list, 
                           lora_request=openchat_request, 
...
# 指定本地文件路径
file_path = '/home/qiuyang/workplace/swift/examples/pytorch/llm/my_data/data_sanyuanzu/openchat_list11_jingtai.json'
