...
# openchat_checkpoint = '/data/home/qiuyang/workplace/swift/examples/pytorch/llm/output/openchat_3.5/v1-20240420-011323/checkpoint-1122'
...
content = '''Review and analyze legislation, laws, or public policy and recommend changes to promote or support interests of the general population or special groups.'''
...
request_list = []
content = '''Review and analyze legislation, laws, or public policy and recommend changes to promote or support interests of the general population or special groups.'''
eval_prompt = f"### Instruction: According to the following information:<{content}> Answer the question. Is there a description of the transfer agent's occupation in the text? What occupation, if any?only give result example [Yes or No,Occupation name].\n### Response:\n"
ques_dict = dict()
