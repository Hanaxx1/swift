...
# openchat_engine = get_vllm_engine(
#     custom.CustomModelType.openchat_35, 
#     model_id_or_path = '/home/qiuyang/workplace/swift/examples/pytorch/llm/output/openchat_3.5/v0-20240131-124616/checkpoint-1948-merged',
#     tensor_parallel_size=2,
#     seed=42
# )

# template_type_openchat = get_default_template_type(model_type_openchat)
# template = get_template(template_type_openchat, openchat_engine.hf_tokenizer)
...
solar_engine = get_vllm_engine(
    custom.CustomModelType.solar_instruct_10_7b,
    model_id_or_path = '/home/qiuyang/workplace/swift/examples/pytorch/llm/output/solar-10.7b-instruct/v1-20240218-003119/checkpoint-1948-merged',
    tensor_parallel_size=2,
    seed=42
)

template_type_solar = get_default_template_type(model_type_solar)
template = get_template(template_type_solar, solar_engine.hf_tokenizer)
...
# count = 0
# 打开JSON文件
with open('/home/qiuyang/workplace/swift/examples/pytorch/llm/my_data/data/c4_data7.json', 'r') as file:
    # 逐行读取文件内容
    for line in file:
        # 解析JSON数据
...
resp_list = inference_vllm(
    solar_engine, template, request_list, generation_config=generation_config, use_tqdm=True,
...
# 指定本地文件路径
file_path = '/home/qiuyang/workplace/swift/examples/pytorch/llm/my_data/data_siyuanzu/solar_list7.json'
